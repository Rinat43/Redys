# Домашнее задание к занятию "`11.2. Кеширование Redis/memcached`" - `Шаяхметов Ринат`
...
Скриншот systemctl 
![image](https://github.com/Rinat43/Redys/blob/main/1.PNG)
...
![image](https://github.com/Rinat43/Redys/blob/main/2.PNG)
...
![image](https://github.com/Rinat43/Redys/blob/main/3.PNG)
